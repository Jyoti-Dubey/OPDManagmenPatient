...
public class DateUtils {
    ...
    public static String[] getCurrentWeek() {
        ...
        for (int i = 0; i < 7; i++) {
            Log.i("TAG ", "WEEK :: " + sdf.format(cal.getTime()));
    ...
    public static String[] getPastWeek() {
        ...
        for (Date x : day) {
            ...
            days[i] = sdf.format(x);
            Log.d(TAG, "PAST WEEK  DD :: " + sdf.format(x));
            i++;
    ...
    public static String[] getCurrentWeekFullDate(String format) {
        ...
        for (int i = 0; i < 7; i++) {
            Log.i("TAG ", "getCurrentWeekFullDate :: " + sdf.format(cal.getTime()));
            days[i] = sdf.format(cal.getTime());
            cal.add(Calendar.DAY_OF_WEEK, 1);
        }
        return days;
    ...
    public static String[] getPastWeekFullDate(String format) {
        ...
        for (Date x : day) {
            ...
            Log.d(TAG, "PAST WEEK :: " + sdf.format(x));
            i++;
        }
        return days;
    }
