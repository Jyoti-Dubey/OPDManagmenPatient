 ...
 * Functionality : This is parent class of this project every activity of this project extends this class
...
public class ParentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String getDeviceInfo() {
        String deviceInfo = "OS VERSION :" + Build.VERSION.RELEASE +
                ...
                + ",MODEL : " + Build.MODEL
                + ",SDK :" + android.os.Build.VERSION.SDK + ",Brand :" + Build.BRAND + ", current app version :: " + getVersionCode() +
                " Login time :: ";
